    ...
    <nav class="navbar navbar-expand-lg bg-light navbar-light fixed-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="/" class="nav-item nav-link active fs-6">Dashboard</a>
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle fs-6" data-bs-toggle="dropdown">Order Management</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="/features" class="dropdown-item">Point of Sale</a>
                        <a href="/booking" class="dropdown-item">Delivery</a>
                        <a href="/booking" class="dropdown-item">Takeout</a>
                    </div>
                </div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        <a href="/features" class="dropdown-item">Settings</a>
                        <a href="/booking" class="dropdown-item">Activity Log</a>
                        <a href="/reservation" class="dropdown-item">Logout</a>
                    </div>
                </div>
            </div>
        </div>
